        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <section id="home" className="relative min-h-screen w-full flex flex-col justify-center items-center">
            ...
            <div className="relative z-10 text-center max-w-2xl mx-auto px-4">
              <span className="text-xs font-mono text-blue-500 mb-2 block">Hello, I'm</span>
              <h2 className="text-4xl md:text-6xl font-bold mb-4">Pablo Artero</h2>
              ...
              <p className="text-sm md:text-base text-zinc-400 mb-12 max-w-lg mx-auto">
            ...
            <div className="mt-6 space-y-8">
              ...
              <div className="max-w-2xl">
                ...
                <p className="text-sm text-zinc-400 mt-4 leading-relaxed">
                  ...
                  problems. I'm currently focused on developing my skills in Java, SolidWorks, and Python to create more
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["SolidWorks", "Java", "Python", "CAD"].map((tech) => (
                    <span
                      key={tech}
          ...
          <section id="education" className="py-10">
            <div className="sticky top-0 py-4 bg-zinc-950 z-10">
              ...
              <div className="flex space-x-2">
                ...
                >
                  {activeTimeline === "education" && <span className="absolute inset-0 bg-blue-500/20 rounded-md" />}
                ...
                >
                  {activeTimeline === "experience" && <span className="absolute inset-0 bg-blue-500/20 rounded-md" />}
                  <span className="relative z-10 flex items-center">
          ...
          <section id="writing" className="py-10">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="mt-8 bg-zinc-900/50 rounded-lg p-6 border border-zinc-800/50">
                ...
                <div className="flex items-center">
                  ...
                  {showNotification && (
                    <span className="ml-4 text-xs text-green-400 animate-pulse">
                ...
                >
                  <div className="p-6 md:p-8">
                    ...
                    <div className="prose prose-invert prose-zinc max-w-none">
                      ...
                      <p className="mb-4">
                        The other day, my friend and I came across an article on a website where a guy was talking about
                        the importance of setting goals in a clear and concise way. In the article, he mentioned things
                        like how novice drivers tend to make more mistakes simply due to a lack of confidence and how
                        they often focus too much on just "getting through" rather than truly mastering the skill.
                      </p>

                      <p className="mb-4">
                        He explained that these drivers make the mistake of fixating on thoughts like "don't crash into
                        this" or "be careful with that," which, without them realizing it, actually makes them more
                        likely to make those very mistakes.
                      </p>

                      <p className="mb-4">
                        After thinking about what the author was saying in his blog, my friend and I realized he was
                        right. Even though it might seem logical that the more you focus on avoiding something, the less
                        likely you are to run into it, that's not really the case. Our minds, whether we like it or not,
                        tend to fixate on the very things we're trying to avoid, making us more prone to the mistakes
                        we're so focused on preventing. And no matter how strange or incorrect this may seem to us, it
                        doesn't stop being true—our minds and subconscious simply work that way.
                      </p>
                      ...
                      <p className="mb-4">
                        ...
                        not even considering failure as an option, you prevent it from happening — and that is precisely
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <div className="prose prose-invert prose-zinc max-w-none">
                      ...
                      <p className="mb-4">
                        ...
                        differentiate between the things you like and the things you don't and little by little, you'll
                        keep <em>narrowing the circle</em> until you land on what you're looking for.
                      </p>
